...
async function main() {
  ...
  fetch(`${REST_URL}/agentmemory/observe`, {
    ...
    (res) => reportCaptureResponse("subagent-start:observe", `${REST_URL}/agentmemory/observe`, res),
    (err) => reportCaptureFailure("subagent-start:observe", `${REST_URL}/agentmemory/observe`, err),
  );
