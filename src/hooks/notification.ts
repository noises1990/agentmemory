...
async function main() {
  ...
  fetch(`${REST_URL}/agentmemory/observe`, {
    ...
    (res) => reportCaptureResponse("notification:observe", `${REST_URL}/agentmemory/observe`, res),
    (err) => reportCaptureFailure("notification:observe", `${REST_URL}/agentmemory/observe`, err),
  );
