...
async function main() {
  ...
  fetch(`${REST_URL}/agentmemory/observe`, {
    ...
    (res) => reportCaptureResponse("post-tool-use:observe", `${REST_URL}/agentmemory/observe`, res),
    (err) => reportCaptureFailure("post-tool-use:observe", `${REST_URL}/agentmemory/observe`, err),
  );
