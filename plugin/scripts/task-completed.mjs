...
async function main() {
	...
	}).then((res) => reportCaptureResponse("task-completed:observe", `${REST_URL}/agentmemory/observe`, res), (err) => reportCaptureFailure("task-completed:observe", `${REST_URL}/agentmemory/observe`, err));
