...
async function main() {
	...
	}).then((res) => reportCaptureResponse("post-tool-failure:observe", `${REST_URL}/agentmemory/observe`, res), (err) => reportCaptureFailure("post-tool-failure:observe", `${REST_URL}/agentmemory/observe`, err));
