...
async function main() {
	...
	}).then((res) => reportCaptureResponse("subagent-stop:observe", `${REST_URL}/agentmemory/observe`, res), (err) => reportCaptureFailure("subagent-stop:observe", `${REST_URL}/agentmemory/observe`, err));
