...
async function main() {
	...
	}).then((res) => reportCaptureResponse("subagent-start:observe", `${REST_URL}/agentmemory/observe`, res), (err) => reportCaptureFailure("subagent-start:observe", `${REST_URL}/agentmemory/observe`, err));
