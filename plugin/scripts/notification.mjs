...
async function main() {
	...
	}).then((res) => reportCaptureResponse("notification:observe", `${REST_URL}/agentmemory/observe`, res), (err) => reportCaptureFailure("notification:observe", `${REST_URL}/agentmemory/observe`, err));
